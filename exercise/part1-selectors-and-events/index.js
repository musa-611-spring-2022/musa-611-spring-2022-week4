...
let secondAndThirdResults = [document.getElementById("result-2"), document.getElementById("result-3")];
...
if (addSpanButton) {
  addSpanButton.addEventListener('click', (evt) => {
    span_number++;
    spanContainer.appendChild(htmlToElement(`<span>${span_number}</span>`));
  });
}
